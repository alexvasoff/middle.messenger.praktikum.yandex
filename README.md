...
Предпологаю, что надо все формы вообще выносить в отдельные компоненты (в условную папку forms) и импортировать в страницу (LoginPage <- LoginForm).
...
Подходит выдержка из сообщения от куратора к текущему состоянию приложения или это уже конец?

> Если придёт фидбек с доработками по проекту, вы сможете сделать это в начале следующей недели.
